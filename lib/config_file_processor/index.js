...
class ConfigFileProcessor extends EventEmitter {
	...
	constructor(userConfigFiles, databaseConfig) {
		super();
		this.config = {};
    this.paths = {};
    this.filehandler = {};
	...
	watch(userConfigFiles, databaseConfig) {
    if (databaseConfig)
      this.databaseConfig = databaseConfig || {};
      ...
      let facility = userConfigFiles[i].name;
			...
			this.config[facility]._name = userConfigFiles[i].name;
			this.config[facility]._title = userConfigFiles[i].title;
